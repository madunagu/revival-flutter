...
class Playable {
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is Playable && id == other.id && name == other.name && srcUrl == other.srcUrl && fullText == other.fullText && description == other.description && authorId == other.authorId && uploaderId == other.uploaderId && type == other.type && size == other.size && length == other.length && language == other.language && createdAt == other.createdAt && updatedAt == other.updatedAt && commentsCount == other.commentsCount && likesCount == other.likesCount && liked == other.liked && viewsCount == other.viewsCount && viewed == other.viewed && comments == other.comments && author == other.author && user == other.user && churches == other.churches && addresses == other.addresses;

  @override
  int get hashCode => id.hashCode ^ name.hashCode ^ srcUrl.hashCode ^ fullText.hashCode ^ description.hashCode ^ authorId.hashCode ^ uploaderId.hashCode ^ type.hashCode ^ size.hashCode ^ length.hashCode ^ language.hashCode ^ createdAt.hashCode ^ updatedAt.hashCode ^ commentsCount.hashCode ^ likesCount.hashCode ^ liked.hashCode ^ viewsCount.hashCode ^ viewed.hashCode ^ comments.hashCode ^ author.hashCode ^ user.hashCode ^ churches.hashCode ^ addresses.hashCode;
}
